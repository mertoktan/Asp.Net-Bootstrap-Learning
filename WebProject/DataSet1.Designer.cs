...
namespace WebProject.DataSet1TableAdapters {
    ...
    public partial class Tbl_OgrenciTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT OGRAD, OGRSOYAD, OGRFOTOGRAF, OGRTELEFON, OGRMAIL, OGRSIFRE\r\nFROM     Tbl_" +
                "Ogrenci\r\nWHERE  (NUMARA = @NUMARA)";
            ...
            this._commandCollection[3].CommandText = "INSERT INTO Tbl_Ogrenci\r\n                  (OGRAD, OGRSOYAD, OGRTELEFON, OGRMAIL," +
        ...
        public virtual int FillOgrencıPaneli(DataSet1.Tbl_OgrenciDataTable dataTable, string NUMARA) {
        ...
        public virtual DataSet1.Tbl_OgrenciDataTable OgrencıPaneliGetir(string NUMARA) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((NUMARA == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, false)]
        public virtual int OgrencıSıfreGuncelle(string OGRSIFRE, string NUMARA) {
...
ON Tbl_Dersler.DERSID=Tbl_Notlar.DERSID
WHERE OGRID=(SELECT OGRID FROM Tbl_Ogrenci WHERE NUMARA=@NUMARA)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
...
ON Tbl_Dersler.DERSID=Tbl_Notlar.DERSID WHERE NOTID=@NOTID";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1.OgrNotlarDataTable OgrNotuGetır(string NUMARA) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((NUMARA == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
    ...
    public partial class Tbl_MesajlarTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT ALICI, BASLIK, GONDEREN, ICERIK, MESAJID FROM Tbl_Mesajlar WHERE (GONDEREN" +
                " = @GONDEREN)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT Tbl_Mesajlar.ALICI, Tbl_Mesajlar.BASLIK, Tbl_Mesajlar.GONDEREN, Tbl_Mesajl" +
                "ar.ICERIK, Tbl_Mesajlar.MESAJID FROM Tbl_Mesajlar INNER JOIN Tbl_Ogrenci ON Tbl_" +
                "Mesajlar.ALICI = Tbl_Ogrenci.NUMARA WHERE (Tbl_Mesajlar.GONDEREN = @GONDEREN)";
            this._commandCollection[2].CommandType = global::System.Data.CommandType.Text;
            ...
            this._commandCollection[3].CommandText = "SELECT Tbl_Mesajlar.ALICI, Tbl_Mesajlar.BASLIK, Tbl_Mesajlar.GONDEREN, Tbl_Mesajl" +
                "ar.ICERIK, Tbl_Mesajlar.MESAJID FROM Tbl_Mesajlar INNER JOIN Tbl_Ogrenci ON Tbl_" +
                "Mesajlar.GONDEREN = Tbl_Ogrenci.NUMARA WHERE (Tbl_Mesajlar.ALICI = @ALICI)";
            this._commandCollection[3].CommandType = global::System.Data.CommandType.Text;
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByGidenKutusuOgr(DataSet1.Tbl_MesajlarDataTable dataTable, string GONDEREN) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((GONDEREN == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual DataSet1.Tbl_MesajlarDataTable OgrencıGıdenKutusu1(string GONDEREN) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((GONDEREN == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByOgrencıGelenKutus1(DataSet1.Tbl_MesajlarDataTable dataTable, string ALICI) {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[4] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[4].Connection = this.Connection;
            this._commandCollection[4].CommandText = "SELECT OGRAD+ \' \' +OGRSOYAD FROM Tbl_Notlar INNER JOIN Tbl_Ogrenci ON Tbl_Notlar." +
                "OGRENCIID=Tbl_Ogrenci.OGRID WHERE Sınav1=(SELECT MAX(Sınav1)\r\nFROM     Tbl_Notla" +
                "r)";
            this._commandCollection[4].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[5] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[5].Connection = this.Connection;
            this._commandCollection[5].CommandText = "SELECT count(*) FROM Tbl_Mesajlar";
            this._commandCollection[5].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[6] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[6].Connection = this.Connection;
            this._commandCollection[6].CommandText = "SELECT COUNT(*) FROM Tbl_Duyurular";
            this._commandCollection[6].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[7] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[7].Connection = this.Connection;
            this._commandCollection[7].CommandText = "SELECT AVG(SINAV1) FROM Tbl_Notlar WHERE DERSID=2";
