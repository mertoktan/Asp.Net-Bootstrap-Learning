<%@ Page Title="" Language="C#" MasterPageFile="~/Ogretmen.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebProject.Default" %>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:HyperLink ID="HyperLink2" NavigateUrl='<%#"~/OgrencıGuncelle.aspx?OGRID="+Eval("OGRID") %>' runat="server" CssClass="btn btn-success">GÜNCELLE</asp:HyperLink>
                        </td>
                    </tr>
                </ItemTemplate>
